...
#Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { hold }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { toggle }]; #IO_L24N_T3_34 Sch=btn[1]
...
#RGB LED 6
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { buzzer }]; #IO_L18P_T2_34 Sch=led6_r
#set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { pressed }]; #IO_L6N_T0_VREF_35 Sch=led6_g
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
...
##Pmod Header JA (XADC)
#set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { buzzer }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p		   
...
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { buzzer }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P             
